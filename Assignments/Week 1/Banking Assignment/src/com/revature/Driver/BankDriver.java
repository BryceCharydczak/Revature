...
import com.revature.DAOImplementations.AccountImp;
import com.revature.DAOImplementations.UserImp;
...
public class BankDriver {
            ...
            if (screenLayer == 0){
                ...
                switch (input = scan.next()){
                    case "1":
                        ...
                        float depositAmt = Math.abs(depositAmount());
                        ...
                        break;
                    case "2":
                        int accountNum2 = withdrawAccount();
    ...
    public static int  withdrawAccount(){
        Scanner s = new Scanner(System.in);
        System.out.println("Please enter the Account Number that you wish to withdraw from:");
        int accountid = s.nextInt();
        return accountid;
    ...
    public static float depositAmount(){
        ...
        if (deposit < 0){
            System.out.println("Ahaha you thought you were slick with the negative, we'll make that positive and process it anyhow >:), more money for us!");
        }
        return deposit;
    ...
    public static float withdrawAmount(){
        ...
        if (withdraw < 0){
            System.out.println("We fixed that negative for you, you sly dog.");
        }
        return withdraw;
    }
